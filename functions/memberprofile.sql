...
BEGIN
    INSERT INTO users_profile(first_name,middle_name,last_name,suffix,nickname,mobile_no,present_address,permanent_address,email,father_full_name,mother_full_name,Beneficiary_full_name,applicationcode,memberKey)
    VALUES(_first_name,_middle_name,_last_name,_suffix,_nickname,_mobile_no,_present_address,_permanent_address,_email,_father_full_name,_mother_full_name,_Beneficiary_full_name,_regCode,_memberKey);   
